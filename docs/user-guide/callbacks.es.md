...
### Callback on_get_user_data {#on_get_user_data-callback}
...
### Callback on_validate_discord_user {#on_validate_discord_user-callback}
...
## Métodos de Difusión {#broadcasting-methods}
