...
We aim to keep `d-back` up to date and secure. Please see below for the versions we currently support with security updates.
...
1. **Contact the maintainer directly at**  [Discord server](https://discord.gg/red)
...
We value the contributions from the community and encourage responsible disclosure to help keep `d-back` safe and secure for all users.
